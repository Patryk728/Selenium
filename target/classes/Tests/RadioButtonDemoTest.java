...
import PageObject.RadioButtonDemo;
 ...
 * @author Patryk
 */
public class RadioButtonDemoTest extends BasePageTest{
    
        private String path=chromePath;
	private RemoteWebDriver webDriver;
	private RadioButtonDemo radioButtonsPage;
	

	public void initializeSettings() {
		radioButtonsPage = new RadioButtonDemo(webDriver);
		radioButtonsPage.openViaUrl(RadioButtonDemo.getUrl());
